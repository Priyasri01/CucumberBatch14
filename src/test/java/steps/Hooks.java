...
public class Hooks extends CommonMethods { //note we are creating this class so that we don't have to create steps
    // " Given user is navigated to HRMS application" in feature file for all the scenario. and also we have more functions(generate report, take screenshot and so on) which we can add it here later part
